...
sys.stdout = io.open(r"E:\game\_work\path_out.txt", "w", encoding="utf-8")
...
disasm(0x4583d0, 30, "OPENFILE 0x4583d0")
disasm(0x458710, 60, "PATHPROC 0x458710")
disasm(0x43c470, 90, "PATHCHECK 0x43c470")
print("done")
