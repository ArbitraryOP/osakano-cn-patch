...
sys.stdout = io.open(r"E:\game\_work\h_out.txt", "w", encoding="utf-8")
...
def disasm(start, count=80, label=""):
    print(f"\n========== {label} 0x{start:08X} ==========")
    o=va2off(start)
    n=0
...
disasm(0x41ad50, 90, "VERIFY-OPCODE 0x41ad50")
disasm(0x416330, 40, "OPCODE 0x416330")
print("done")
